      ...
      try {
        ...
        try {
          ...
          aggregated.push(...postsData.slice(0, 2).map((p, i) => ({
            ...
            type: "POST",
            tag: "LOG",
            icon: <FaComments className="text-yellow-200 mt-0.5" />,
    ...
    <div className="relative min-h-screen bg-[#e5e5e5] text-black font-mono overflow-hidden flex flex-col pt-20">
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto flex-1 flex flex-col md:grid md:grid-cols-12 border-t-4 border-black">
        ...
        <div className="md:col-span-8 flex flex-col min-h-[400px] md:min-h-[400px]">
          ...
          <div className="h-10 bg-orange-400 flex items-center px-6 justify-between border-b border-white/10">
            <div className="flex gap-1 h-full items-center">
              {[...Array(8)].map((_, i) => (
                <div key={i} className={`w-8 h-1/2 -skew-x-[25deg] ${i < 3 ? 'bg-white' : 'bg-white/10'}`}></div>
              ))}
            </div>
            <div className="text-white text-[9px] font-black tracking-[0.4em] flex items-center gap-2">
              <FaCrosshairs size={10} className="text-yellow-200" />
          ...
          <div className="flex-1 flex flex-col md:flex-row border-b-2 border-black/10 relative overflow-hidden bg-[#0a0a0a] group/hero">
            ...
            >
              ...
              <div className="absolute top-6 left-6 flex flex-col gap-1 pointer-events-none">
                <span className="text-[8px] font-black text-yellow-200 tracking-[0.4em] opacity-50">NODE_ACCESS_POINT</span>
                <span className="text-4xl font-heading text-white/10 uppercase tracking-tighter">OS_VERSION_2.0</span>
              </div>

              {/* HUD 002 (Minimalist) */}
              <div className="absolute bottom-8 left-8 right-8 bg-black/40 backdrop-blur-md p-5 border border-white/5 group-hover/f2:border-yellow-200/30 transition-colors">
                <div className="flex justify-between items-center text-[7px] text-white/40 mb-3 font-mono">
                  <span className="flex items-center gap-1.5"><div className="w-1 h-1 bg-yellow-200 rounded-full animate-pulse"></div> INTEL_FETCH_SUCCESS</span>
            ...
            >
              ...
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-10 right-10 w-20 h-20 border-t border-r border-yellow-200/20"></div>
                <div className="absolute bottom-40 left-10 w-20 h-20 border-b border-l border-yellow-200/20"></div>
                {/* Brand Floating Label */}
                <div className="absolute top-12 left-12 flex flex-col pointer-events-none">
                  <motion.span
                    initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1 }}
                    className="text-[10px] font-black text-yellow-200 tracking-[0.6em] mb-2 drop-shadow-lg"
        ...
        <div className="md:col-span-4 border-l border-black/10 bg-gray-900 flex flex-col relative">
          ...
          <div className="p-8 border-b border-white/5 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 bg-yellow-200 rounded-full animate-ping"></div>
          ...
          <div className="px-8 py-4 border-b border-white/5 bg-white/5">
            ...
            <p className="text-[9px] font-black text-yellow-200 mt-2 tracking-widest">— NEERAJ KUMAR SAINI, FOUNDER</p>
          </div>
          ...
          <div className="flex-1 overflow-y-auto scrollbar-tech p-8 space-y-6">
            ...
            {loadingUpdates ? (
              ...
              >
                <div className="flex justify-between items-center text-[7px] font-black text-yellow-200/60 mb-2">
                ...
                <div className="flex items-center gap-2 mt-3 opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  <FaArrowRight size={10} className="text-yellow-200" />
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="p-8 bg-black/40 border-t border-white/5">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-[12px] font-black text-yellow-200 animate-pulse">OPTIMIZED</span>
              </div>
            </div>
            <button
              onClick={() => navigate('/dashboard')}
              className="mt-6 w-full py-4 bg-white text-black font-black text-[10px] tracking-[0.3em] hover:bg-yellow-200 transition-colors flex items-center justify-center gap-3 group"
            >
              ACCESS_FULL_SYSTEM
